...
export const MailOutlineIcon: React.FC<IconSvgProps> = (props) => (
  <svg
...
// เพิ่มไอคอนใหม่แบบทึบ
export const MailFilledIcon: React.FC<IconSvgProps> = (props) => (
  <svg
    height={props.size || 20}
    viewBox="0 0 24 24"
    width={props.size || 20}
  ...
  >
    <path
      d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-8 7L4 6h16l-8 5z"
      fill="currentColor"
    />
  </svg>
);
